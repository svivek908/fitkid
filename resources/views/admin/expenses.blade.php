                  ...
                  <table id="simpletable"class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$mc->name}}</td>
                           <td>{{$mc->amount}}</td>
                           <td>@php echo date('Y-m-d',strtotime($mc->created_at)); @endphp</td>
                           <td>
                            <i class="fa fa-pencil data-table-edit" data-id="{!! $mc->id; !!}" data-editurl="{{url('admin/edit_expenses')}}" title="Edit"> </i>
                            <i class="fa fa-trash delete" data-id="{!! $mc->id; !!}" data-url="{{url('admin/delete_expenses')}}" data-redirecturl="{{url('admin/expenses')}}" title="Delete"> </i> 
                         </td>
                        </tr>
                        @endforeach
                        @endif
