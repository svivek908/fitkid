...
<section id="wrapper" class="login-register login-sidebar">
  ...
  <div class="row justify-content-center">
    <div class="col-md-5 text-center parallax-fade-top subscribe-bg">
      <div class="mt-40">
        <div class="main-title on-dark text-center mb-0"> <a href="index.html" class="text-center db"><img src="plugins/assets/img/logo.png" alt="Home" / style="width: 50%"><br/>
        
          <div class="main-subtitle-bottom smaller mt-10">Register Now!</div>
        </div>
        <form class="form-horizontal form-material" id="loginform" action="http://creativethemes.co.in/demo/studioux/admin-dashborad-template/index.html">
          ...
          <div class="form-group">
            <div class="col-xs-12">
              <div class="checkbox checkbox-primary pt-0" style="text-align: left;padding: 0 20px;">
          ...
          <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
              <p>Already have an account? <a href="index.php" class="text-danger ml-5"><b>Sign In</b></a></p>
            </div>
          </div>
          <div class="row">
